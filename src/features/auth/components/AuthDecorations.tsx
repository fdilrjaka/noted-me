...
/**
 * Sticky note kertas tempel dekoratif dengan lipatan sudut dan tulisan tangan.
 */
function StickyNote({
  lines,
  fill,
  ...
  return (
    <div className={className} style={{ width, height }}>
      <svg
        ...
        className="absolute inset-0 drop-shadow-[0_8px_16px_rgba(120,90,20,0.12)]"
      >
      ...
      <div
        className="relative flex h-full flex-col items-center justify-center gap-0.5 px-3 text-center text-[13px] leading-tight text-amber-900 select-none"
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden select-none" aria-hidden="true">
      ...
      <StickyNote
        ...
        width={140}
        height={90}
        className="absolute right-8 top-8 rotate-[4deg] sm:right-16 sm:top-12"
      />
      ...
      <StickyNote
        ...
        height={108}
        hasHeart
        className="absolute -left-2 bottom-12 -rotate-[6deg] sm:left-10 sm:bottom-16"
      />

      {/* Mini floating dock ikon kiri vertikal (tanpa logo) */}
      <div className="absolute left-6 top-1/2 hidden -translate-y-1/2 flex-col items-center gap-2 rounded-2xl border border-slate-200/90 bg-white/90 p-2 shadow-sm backdrop-blur-md lg:flex">
      ...
      {/* Kontrol zoom, fullscreen & tile smiley di pojok kanan bawah */}
      <div className="absolute bottom-6 right-6 hidden items-center gap-2 sm:flex">
        <div className="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 shadow-xs">
        ...
        {/* Kotak senyum ungu kecil di sudut kanan bawah */}
        <span className="flex size-8 items-center justify-center rounded-xl bg-purple-100 text-purple-600 border border-purple-200/60 shadow-xs">
