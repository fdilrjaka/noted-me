...
export function CollabIllustration() {
  return (
    <div className="relative hidden h-[34rem] w-full max-w-xl lg:block" aria-hidden="true">
      ...
      <svg className="absolute inset-0 size-full pointer-events-none" viewBox="0 0 560 560" fill="none">
        <defs>
        ...
        <path d="M 40 300 C 110 300, 110 150, 190 150" stroke="#94a3b8" strokeWidth="1.5" fill="none" />
        <path d="M 40 300 C 110 300, 110 300, 190 300" stroke="#94a3b8" strokeWidth="1.5" fill="none" />
        <path d="M 40 300 C 110 300, 110 450, 190 450" stroke="#94a3b8" strokeWidth="1.5" fill="none" />

        {/* Garis Penghubung Vertikal / Antar Kartu */}
        <path d="M 190 180 V 270" stroke="#94a3b8" strokeWidth="1.5" fill="none" />
        <path d="M 330 150 C 370 150, 370 110, 420 110" stroke="#94a3b8" strokeWidth="1.5" fill="none" markerEnd="url(#arrow)" />
        <path d="M 330 300 C 370 300, 370 370, 420 370" stroke="#94a3b8" strokeWidth="1.5" fill="none" markerEnd="url(#arrow)" />
        <path d="M 420 350 V 230" stroke="#94a3b8" strokeWidth="1.5" fill="none" markerEnd="url(#arrow)" />
      </svg>
