...
export function GreetingBanner({ name }: { name?: string }) {
  ...
  return (
    <section className="glass-card relative overflow-hidden rounded-3xl p-6 sm:p-7 border border-white/80 shadow-sm bg-gradient-to-r from-white/80 via-white/50 to-emerald-50/40">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="relative z-10 sm:self-center self-end pr-2 pt-2 sm:pt-0">
          <div className="rotate-[-6deg] font-handwriting text-slate-700 text-xl sm:text-2xl font-bold flex flex-col items-center">
            <span>Progress</span>
            <span className="flex items-center gap-1 -mt-1">
              not perfection
              <span className="text-lg"></span>
            </span>
            <svg width="100" height="12" viewBox="0 0 100 12" className="text-slate-600/60 stroke-current fill-none">
