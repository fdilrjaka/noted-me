          ...
          {items.map(({ to, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                <ChevronRight className={`size-4 flex-none opacity-60 transition-all duration-200 ${active ? "translate-x-0" : "opacity-0 group-hover:opacity-70 group-hover:translate-x-0.5"}`} />
              </Link>
            );
          })}
        </nav>
