  ...
  return (
    <div className="glass-soft relative rounded-2xl p-4 transition-all">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs pt-1 pb-2">
        <div>
          <span className="block text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">TIME</span>
        ...
        <div>
          <span className="block text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">LOKASI</span>
          <div className="flex items-center gap-1 mt-1 font-medium text-foreground">
        ...
        <div>
          <span className="block text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">STATUS</span>
        ...
        <div>
          <span className="block text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">Dosen</span>
      ...
      {item.lmsLinks && item.lmsLinks.map((lms, idx) => (
        <div key={idx} className="glass-soft mt-3 flex items-center justify-between rounded-xl p-1.5 pl-3">
          <a
            href={lms.url}
            target="_blank"
